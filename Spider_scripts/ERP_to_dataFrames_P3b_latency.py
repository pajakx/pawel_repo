...
for participant in participants:
    ...
    data_ready_nodis = data_nodis.idxmax() 
    data_ready_buzz = data_buzz.idxmax()
    data_ready_neutral = data_neutral.idxmax()
...
data_latency_max_amplitudes_targets = pandas.concat(master_list,ignore_index=True)

#Save dataframe to csv file

data_latency_max_amplitudes_targets.to_csv(r'C:\Users\user\Desktop\FOCUS\data_amplitudes\latency_max_amp_targets.csv', index = None, header=True)
