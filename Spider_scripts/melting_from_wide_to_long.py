...
#merging
data1 = pd.read_excel(r'C:\Users\Pawel\Desktop\Braille_Project\BRAJL_LOGI\surowe\mirror\manually_checked_blind\results_blind\behavioral_results_blind_runMEAN.xlsx')
data2 = pd.read_excel(r'C:\Users\Pawel\Desktop\Braille_Project\BRAJL_LOGI\surowe\mirror\manually_checked\results\behavioral_results_sighted_runMEAN.xlsx')
...
result1 = result[result.participant.str[:1] != 'L'].reset_index()
result1.drop('index', inplace=True, axis=1)

result1.to_excel(r'C:\Users\Pawel\Desktop\Braille_Project\BRAJL_LOGI\behavioral_results_merged_no_Longitudinal.xlsx')
#max_amp_targets
...
## add the qualtrics survey data to the master wide

dat1 = pd.read_csv(r'C:\Users\Pawel\Desktop\FOCUS\behavioral\ready_to_stat\master_data_wide_mDNA.csv')
dat2 = pd.read_csv(r'C:\Users\Pawel\Desktop\FOCUS\behavioral\ready_to_stat\Survey_nice.csv')

merg=dat1.merge(dat2)

merg.to_csv(r'C:\Users\Pawel\Desktop\FOCUS\behavioral\ready_to_stat\master_data_wide_mDNA_with_survey.csv', index = None, header=True)
