...
df_forplot = df_forplot.replace({'buzz_block': 'smartphone sound', 'nodis_block': 'no sound', 'neutral_block': 'neutral sound'})

df_forplot = df_forplot.rename(columns={"blocks": "conditions"})


P3b_social_amplitude = sns.lmplot(x="socialmedia_mean", y="target_maxAmp_Pz", hue="conditions", data=df_forplot);
...
sns.lmplot(x="socialmedia_mean", y="latency_target_maxAmp_Pz", hue="conditions", data=df_forplot);

###Plot the relation of average social media usage with latency in different sounds
##3 regression lines overlapping 
...
df_forplot = df_forplot.replace({'buzz_block': 'smartphone sound', 'neutral_block': 'neutral sound'})

df_forplot = df_forplot.rename(columns={"blocks": "conditions"})


P3a_social_latency = sns.lmplot(x="socialmedia_mean", y="sounds_latency_Cz", hue="conditions", data=df_forplot);
plt.xlabel("Social Media Apps Usage [min/day]")
...
###Plot the relation of average screen time usage with max amplitude in different blocks
##3 regression lines overlapping 
...
df2= dupa['screentime_mean'].dropna()
...
P3b_screentime_mean_amplitude = sns.lmplot(x="screentime_mean", y="target_maxAmp_Pz", hue="blocks", data=df_forplot);
plt.xlabel("Average screen time [min/day]")
plt.ylabel("P3b Amplitude [uV]")
#plt.title("") # You can comment this line out if you don't need title
plt.show(P3b_screentime_mean_amplitude)
