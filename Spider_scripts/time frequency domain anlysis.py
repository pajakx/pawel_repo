...
# Main Directory 
filepath = r'C:\Users\user\Desktop\FOCUS\Preprocessed_TimeFreqDom\epoched_TFA'
...
baseline_grand.plot_psd(picks = parietal_min, fmax = 15, fmin = 5, average = True, bandwidth = 1)
manual_grand.plot_psd(picks = parietal_min, fmax = 15, fmin = 5, average = True, bandwidth = 1)
low_grand.plot_psd(picks = parietal_min, fmax = 15, fmin = 5, average = True, bandwidth = 1)
medium_grand.plot_psd(picks = parietal_min, fmax = 15, fmin = 5, average = True, bandwidth = 1)
high_grand.plot_psd(picks = parietal_min, fmax = 15, fmin = 5, average = True, bandwidth = 1)