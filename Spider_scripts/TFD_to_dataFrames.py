...
########################
    ...
    for electrode in parietal:
      ...
      # Compute the average absolute power by approximating the area under the curve
      ...
      #Compute average absolute power with baseline correction (Decibel Conversion dB = 10*log10(signal/baseline))
...
#for average absolute alpha power with baseline correction
...
data_frequency.to_csv(r'C:\Users\user\Desktop\FOCUS\behavioral\ready_to_stat\data_frequency.csv', index = None, header=True)    
